...
# Python runtime dependencies (self-contained, no dependency on Network Volume site-packages)
COPY requirements.inference.txt .
RUN pip install --no-cache-dir -r requirements.inference.txt

# zi2zi-JiT 模型源码（仓库较小；权重走网络卷）
RUN git clone --depth 1 https://github.com/kaonashi-tyc/zi2zi-JiT.git /app/zi2zi-jit

# 源字体/content font：使用稳定的 Noto Sans CJK SC OTF
...
ENV PYTHONPATH=/runpod-volume/zi2zi-jit/site-packages:/runpod-volume/zi2zi-jit/zi2zi-jit-src:/app/zi2zi-jit:$PYTHONPATH
